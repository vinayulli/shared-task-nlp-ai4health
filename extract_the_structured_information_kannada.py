...
# Point DSPy to Ollama's OpenAI-compatible endpoint
# Point DSPy to Ollama's OpenAI-compatible endpoint
lm = dspy.LM(
    "openai/qwen3-ie:latest",         # <-- your Ollama model name (from `ollama list`)
    api_base="https://a0yy4b3et3iys4-11434.proxy.runpod.net/v1", # default Ollama server URL
    api_key="local",                      # any non-empty string is fine
